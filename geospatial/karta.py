...
def plp(  # plp: points, lines, polygons
    ...
    if geohash_res > 0:  # inner=False doesn't work if compact=True
        ...
        cells, _ = gindex.poly_to_cell_parallel(cdf, cell_type="geohash", res=geohash_res, compact=compact)
    ...
    if s2_res > -1:
        ...
        cells, _ = gindex.poly_to_cell_parallel(cdf, cell_type="s2", res=s2_res, compact=compact)
    ...
    if h3_res > -1:
        ...
        cells, _ = gindex.poly_to_cell_parallel(cdf, cell_type="h3", res=h3_res, compact=compact)
